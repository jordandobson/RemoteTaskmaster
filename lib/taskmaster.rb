...
# New requirements:
# 
# * The server should keep the list of defined tasks for the life of the serverÉ that is, if you disconnect and reconnect the client, the tasks should stay defined
...
# Notes:
# 
# * Running a single task multiple times should execute the dependencies each timeÉ that is, track the dependencies in the scope of a single Taskmaster.run call
